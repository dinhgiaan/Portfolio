                  ...
                  <div className="max-w-4xl mx-auto">
                        <Card className="mb-8 border-2 hover:border-primary/20 transition-colors duration-300">
                              <CardContent className="p-8">
                                    <div className="flex justify-center gap-2 mb-6 cursor-default text-center">
                                          <Badge variant="secondary" className="px-3 py-1">Available for work</Badge>
                                          <Badge variant="outline" className="px-3 py-1">Open to collaborations</Badge>
                                    </div>
                                                      ...
                                                      <Card key={index} className="group hover:shadow-md transition-all duration-300 border hover:border-primary/20">
                                                            <CardContent className="px-4">
                                                                  <div className="flex items-center gap-4">
                                                                        <div
                                                                              className={`w-12 h-12 rounded-lg ${item.bgColor} flex items-center justify-center transition-colors duration-200`}
                                                                        >
                                                                        ...
                                                                        <div className="flex-1 min-w-0">
                                                                              ...
                                                                              <p className="text-[12px] font-mono break-all">{item.value}</p>
                                                                        </div>
                                    ...
                                    <div className="mt-8 flex justify-center">
                                          <Button
                                                ...
                                                onClick={() =>
                                                      window.open("https://mail.google.com/mail/?view=cm&fs=1&to=dinhgiaanforwork@gmail.com", "_blank")
                                                }
                                          >
